...
func (c *NodeshiftClient) CreateGPU(ctx context.Context, gpu *GPUConfig) (*GPUConfigResponse, error) {
...
func (c *NodeshiftClient) GetGPU(ctx context.Context, id string) (*RentedGpuInfoResponse, error) {
...
func (c *NodeshiftClient) UpdateGPU(ctx context.Context, id string, gpu *GPUConfig) (*GPUConfig, error) {
